...
public class Main
{
	...
	public static void main(String args[])
    {
        ...
        try
        {
            ...
            Account product = new Account("Sony Discman","A standard discman from Sony",200.00);
            Operations book = new Operations("Lord of the Rings by Tolkien","The classic story",49.99,"JRR Tolkien", "12345678", "MyBooks Factory");
        ...
        try
        {
            ...
            for (Account product : (List<Account>)q.execute()) {
            	System.out.println(">  " + product);
            	if (product instanceof Operations)
                {
                    Operations b = (Operations)product;
